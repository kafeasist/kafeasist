...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out border-border",
  {
    variants: {
      side: {
...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps
>(({ side = "right", closable = true, className, children, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay />
