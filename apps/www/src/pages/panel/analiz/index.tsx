        ...
        <div>
          <div className="flex-1 p-8 pt-6">
            ...
            <div className="mt-2 text-sm text-muted-foreground">
              Analizlerinizi buradan oluşturabilir, geçmiş analizlerinizi
            ...
            <Card className="mx-8 md:ml-2 md:mr-10">
              ...
              <CardContent>
                <p className="mb-4 text-sm">
                  ...
                  verilerini ve analiz yapılacak tarih aralığını seçerek analiz
                  oluşturabilirsiniz. Bu analiz türünde, analiz sonuçları
                  binlerce restoranın verileri ile eğitilerek oluşturulmuş yapay
                  zeka modeli tarafından oluşturulur. Analiz oluşturduktan sonra
